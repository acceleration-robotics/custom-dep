...
class NaiveRadarBridge : public rclcpp::Node
{
  ...
  /// If subscribers are present, we initiate subscription to the gz
  ...
  public: void OnData(const gz::msgs::Float_V &_msg)
  {
  ...
  private: gz::transport::Node ignNode;
